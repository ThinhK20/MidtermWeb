      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="flex items-center justify-between h-20">
          ...
          <div className="shrink-0 mr-4">
            {/* Logo */}
            <a href="/" className="flex items-center" aria-label="Cruip">
              ...
              <span className='text-2xl px-2'> Travel</span>
            </a>
          </div>
          ...
          <nav className="hidden md:flex md:grow">
            ...
            <div className="flex grow justify-end flex-wrap items-center relative">
              <div className="text-[1.4rem]">
                  <a href="#" className='mx-3 hover:underline'>Home</a>
                  <a href="#" className='mx-3 hover:underline'>About</a>
                  <a href="#" className='mx-3 hover:underline'>Explored</a>
                  <a href="#" className='mx-3 hover:underline'>Gallery</a>
