...
const PakageItem = ({title, url, price, des, duration}: PakageProps) => {
    return(
        <div className="group cursor-pointer ">
            ...
            <div className="p-4 bg-slate-100">
                ...
                <div className="flex items-center justify-between">
                    ...
                    <a href="/" className="medium-14 px-4 py-2 rounded-md border bg-black hover:scale-105 transform transition duration-300 ease-out">
