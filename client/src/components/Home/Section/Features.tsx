      ...
      <div className="max-w-full mx-auto padding-container py-12 lg:py-20">
         ...
         <div className="font-light sm:text-lg">
            <h1 className="bold-40 font-extrabold text-center">
               Road Trip All-Inclusice Resorts
            </h1>
         ...
         <div className=" gap-4 items-center lg:grid lg:grid-cols-2 p-2 ">
            <div className="lg:flex lg:items-center">
               ...
               <div className="grid w-full grid-cols-1 gap-8 xl:gap-16 md:grid-cols-2">
                  <div className="space-y-3">
                     ...
                     <h1 className="text-xl font-semibold text-black-700 capitalize">
                        New Components
                     </h1>
