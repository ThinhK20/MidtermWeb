    ...
    <div className="w-[100%] h-auto padding-container py-20 shadow-md bg-white hover:shadow-xl rounded-3xl">
        <div className="my-10">
            ...
            <div className=" items-center py-2 mt-5 w-full regular-16 bg-transparent border-0 border-b-2 border-gray-300">
                <form>
                    <div className="w-1/3">
                        <label className="" about="password">Current Password</label>
                        <input id="password" type="password" className="w-full px-4 py-2 mt-2 bg-white border-1 ring-1 ring-black/50 border-gray-200 rounded-md shadow-md hover:ring-black" placeholder="Enter current password" required/>
                    </div>
                    <div className="flex w-full gap-4 mt-10">
                        <div className="w-1/3">
                            <label className="" about="password">New Password</label>
                            <input id="password" type="password" className="w-full px-4 py-2 mt-2 bg-white border-1 ring-1 ring-black/50 border-gray-200 rounded-md shadow-md hover:ring-black" placeholder="Enter new password" required/>
                        </div>
                        <div className="w-1/3">
                            <label className="" about="password">Confirm Password</label>
                            <input id="password" type="password" className="w-full px-4 py-2 mt-2 bg-white border-1 ring-1 ring-black/50 border-gray-200 rounded-md shadow-md hover:ring-black" placeholder="Enter confirm password" required/>
                        </div>
                    </div>

                    <div className="flex w-[100%] justify-end items-center">
                        <button type="submit" className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-slate-50 regular-16 rounded-lg text-sm w-full sm:w-auto px-5 py-5 text-center">Change password</button>
                    </div>
                </form>
        ...
        <div className="my-10">
            ...
            <div className="flex justify-between items-center py-6 w-full regular-16 bg-transparent border-0 border-b-2 border-gray-300">
                ...
                <div className="flex pr-2 gap-4 items-center flex-nowrap">
                    ...
                    <span className="px-2 text-blue-400 cursor-pointer">Disconnect</span>
                </div>
            </div>
            ...
            <div className="flex justify-between items-center py-6 w-full regular-16 bg-transparent border-0 border-b-2 border-gray-300">
                <div className="flex w-1/2 items-center justify-between">
                    <div className="flex items-center">
                        <FontAwesomeIcon icon={faFacebook} className="w-12 h-12 mx-2 text-blue-800"/>
            ...
            <div className="flex justify-between items-center py-6 w-full regular-16 bg-transparent border-0 border-b-2 border-gray-300">
                <div className="flex w-1/2 items-center justify-between">
                    <div className="flex items-center">
                        <FontAwesomeIcon icon={faLinkedin} className="w-12 h-12 mx-2 text-blue-800"/>
            ...
            <div className="flex justify-between items-center py-6 w-full regular-16 bg-transparent border-0 border-b-2 border-gray-300">
                <div className="flex w-1/2 items-center justify-between">
                    <div className="flex items-center">
                        <FontAwesomeIcon icon={faGithub} className="w-12 h-12 mx-2 text-black"/>
                        <span className="px-2">Linkedin</span>
                    </div>
