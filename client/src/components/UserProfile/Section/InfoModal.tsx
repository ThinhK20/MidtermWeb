      ...
      <>
         <div className="relative w-[100%] h-auto px-40 py-20 shadow-md bg-white hover:shadow-xl rounded-3xl">
            ...
            <form>
               ...
               <div className={`${(isEdit) ? 'visible': 'invisible'} flex w-[100%] justify-end items-center px-10`}>
                  <button
                     type="button"
                     onClick={() => {
            ...
            <div className={`${(!isEdit) ? 'visible': 'invisible'} w-50 absolute top-10 right-10 group`}>
               <div className="text-black medium-18 flex justify-center items-center gap-2  cursor-pointer border-b border-transparent hover:border-blue-600 transition-all group-hover:scale-110 ease-linear duration-300 group-hover:text-blue-600"
                  onClick={() => {
                     setEdit(true);
                     }}
               >
