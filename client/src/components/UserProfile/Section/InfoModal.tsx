      ...
      <form>
        ...
        <div className="grid md:grid-cols-2 gap-4 md:gap-6 mb-12">
          <div className="relative z-0 w-full group">
            <input
              ...
              value={
                userBasicInfo.facebook ||
                "" ||
                localStorage.getItem("facebook")?.toString()
              }
            />
        ...
        <div className="grid md:grid-cols-10 gap-4 md:gap-6 mb-12">
          <div className="relative z-0 w-full md:col-span-8  group">
            <input
              ...
              value={
                userBasicInfo.location ||
                "" ||
                localStorage.getItem("location")?.toString()
              }
            />
            <label
            ...
            <fieldset className="flex gap-10">
              ...
              <div className="flex items-center mb-4 gap-2">
                <input
                  ...
                  checked={localStorage.getItem("gender") == "Male"}
                />
                <label
              ...
              <div className="flex items-center mb-4 gap-2">
                <input
                  ...
                  checked={localStorage.getItem("gender") == "Female"}
                />
                <label
                  about="country-option-1"
        ...
        <div className="flex w-[100%] justify-end items-center px-10">
          <button
            type="button"
            onClick={() => {
              updateUserApi(userBasicInfo).then((value) => console.log(value));
            }}
