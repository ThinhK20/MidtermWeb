      ...
      <div className="relative w-[100%] h-auto px-40 py-20 shadow-md bg-white hover:shadow-xl rounded-3xl">
        ...
        <form>
          ...
          <div className="grid md:grid-cols-2 gap-4 md:gap-6 mb-12">
            ...
            <div className="relative z-0 w-full group">
              ...
              <label
                ...
                className="peer-focus:medium-20 absolute medium-18 text-gray-500 duration-300 transform -translate-y-8 scale-75 top-3 -z-10 origin-[0] peer-focus:start-0 rtl:peer-focus:translate-x-1/4 rtl:peer-focus:left-auto peer-focus:text-blue-600  peer-placeholder-shown:scale-125 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-10"
              >
                <FontAwesomeIcon icon={faUserCircle} className="pr-3" />
                User name
              </label>
            </div>
          ...
          <div className="grid md:grid-cols-8 gap-4 md:gap-6 mb-6">
            ...
            <div className="relative z-0 w-full group md:col-span-3">
              <input
                ...
                name="floating_phone"
                id="floating_phone"
                className="block py-2.5 px-0 w-full regular-16 text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none focus:outline-none focus:ring-0 focus:border-blue-600 peer placeholder-black placeholder:focus:text-gray-400"
              ...
              <fieldset className="flex gap-10">
                <div className="flex items-center mb-4 gap-2">
                  <input
                    ...
                    checked={userBasicInfo.gender === "Male"}
                    disabled={!isEdit}
                  />
                  <label
                    about="Gender-1"
                ...
                <div className="flex items-center mb-4 gap-2">
                  <input
                    ...
                    checked={userBasicInfo.gender === "Female"}
                    disabled={!isEdit}
                  />
                  <label
                    about="Gender-2"
          ...
          <div
            ...
            } flex w-[100%] justify-end items-center px-10`}
          >
            <button
              type="button"
              onClick={() => {
                updateUserApi(userBasicInfo).then((value) => {
                  console.log(value);
                  setEdit(true);
                  toast.success("Upload Info Basic successfully!");
                });
              }}
        ...
        <div
          className={`${
            !isEdit ? "visible" : "invisible"
          } w-50 absolute top-10 right-10 group`}
        >
          <div
            className="text-black medium-18 flex justify-center items-center gap-2  cursor-pointer border-b border-transparent hover:border-blue-600 transition-all group-hover:scale-110 ease-linear duration-300 group-hover:text-blue-600"
            onClick={() => {
              setEdit(true);
            }}
          >
